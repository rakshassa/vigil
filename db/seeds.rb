...
Trinket.where(name: "Mesmerize").first_or_create(desc: "You can use your skills one extra time per day.", cost: 3, icon: "bi-hypnotize", effects: [{ name: "MaxSkills", value: 1 }])
Trinket.where(name: "Scavenger").first_or_create(desc: "You find gems more often (15%).", cost: 5, icon: "bi-piggy-bank", effects: [{ name: "GemFind", value: 15 }])
